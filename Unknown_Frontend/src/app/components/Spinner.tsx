...
export const Spinner = () => {
	return (
		<div>
			...
			<LoadingIcons.Bars /> <br />
			<LoadingIcons.Audio /> <br />
			<LoadingIcons.BallTriangle /> <br />
			<LoadingIcons.Bars /> <br />
			<LoadingIcons.Circles /> <br />
			<LoadingIcons.Grid /> <br />
			<LoadingIcons.Hearts /> <br />
			<LoadingIcons.Oval /> <br />
			<LoadingIcons.Puff /> <br />
			<LoadingIcons.Rings /> <br />
			<LoadingIcons.SpinningCircles /> <br />
			<LoadingIcons.TailSpin /> <br />
			<LoadingIcons.ThreeDots /> <br />
		</div>
	);
};
